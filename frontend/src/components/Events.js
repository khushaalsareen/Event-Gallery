...
// Form the string representation of the date
      ...
      return ele.eventType === 'Coding' && ele.eventStatus!=='Completed' && (dateString===ele.endDate || new Date(ele.endDate)>Date.now())
    })
...
// Form the string representation of the date
      ...
      return ele.eventType === 'Sport' && ele.eventStatus!=='Completed' && (dateString===ele.endDate || new Date(ele.endDate)>Date.now())
    })
...
// Form the string representation of the date
      ...
      // return ele.eventType === 'Coding' && ele.eventStatus!=='Completed' && (dateString===ele.endDate || new Date(ele.endDate)>Date.now())
      return ele.participatedStudents > 0 && (dateString===ele.endDate ||new Date(ele.endDate)>Date.now())
    })
...
// Form the string representation of the date
      ...
      return ele.eventType === 'Culture' && ele.eventStatus!=='Completed' && (dateString===ele.endDate || new Date(ele.endDate)>Date.now())
    })
